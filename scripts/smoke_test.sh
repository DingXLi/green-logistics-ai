...
# ---- iter #55: top suppliers/vehicles by efficiency ----
check_endpoint "/api/persistence/top-suppliers (iter #55)" 200 GET "/api/persistence/top-suppliers"
check_json_field "/api/persistence/top-suppliers has metric" GET "/api/persistence/top-suppliers" ".metric | type" "string"
check_json_field "/api/persistence/top-suppliers has top_suppliers array" GET "/api/persistence/top-suppliers" ".top_suppliers | type" "array"
check_endpoint "/api/persistence/top-suppliers?metric=cost_per_ton" 200 GET "/api/persistence/top-suppliers?metric=cost_per_ton"
check_endpoint "/api/persistence/top-suppliers?metric=match_rate" 200 GET "/api/persistence/top-suppliers?metric=match_rate"
...
# iter #57: top-demands-by-fulfillment endpoint
check_endpoint "/api/persistence/top-demands (iter #57)" 200 GET "/api/persistence/top-demands"
check_json_field "/api/persistence/top-demands has metric" GET "/api/persistence/top-demands" ".metric | type" "string"
check_json_field "/api/persistence/top-demands has top_demands array" GET "/api/persistence/top-demands" ".top_demands | type" "array"
...
# iter #59: top-facilities-by-distance endpoint
check_endpoint "/api/persistence/top-facilities (iter #59)" 200 GET "/api/persistence/top-facilities"
check_json_field "/api/persistence/top-facilities has metric" GET "/api/persistence/top-facilities" ".metric | type" "string"
check_json_field "/api/persistence/top-facilities has top_facilities array" GET "/api/persistence/top-facilities" ".top_facilities | type" "array"
check_json_field "/api/persistence/top-facilities has filter block" GET "/api/persistence/top-facilities" ".filter | type" "object"
check_endpoint "/api/persistence/top-facilities?metric=total_matched_tons" 200 GET "/api/persistence/top-facilities?metric=total_matched_tons"
check_endpoint "/api/persistence/top-facilities?metric=utilization_pct" 200 GET "/api/persistence/top-facilities?metric=utilization_pct"
check_endpoint "/api/persistence/top-facilities?metric=co2_per_ton" 200 GET "/api/persistence/top-facilities?metric=co2_per_ton"
check_endpoint "/api/persistence/top-facilities?city=G%C3%B6teborg" 200 GET "/api/persistence/top-facilities?city=G%C3%B6teborg"
check_endpoint "/api/persistence/top-facilities?facility_type=metal_recovery" 200 GET "/api/persistence/top-facilities?facility_type=metal_recovery"
...
# iter #69: solver-duration-by-season endpoint
check_endpoint "/api/persistence/solver-duration-by-season (iter #69)" 200 GET "/api/persistence/solver-duration-by-season"
check_json_field "/api/persistence/solver-duration-by-season has seasons array" GET "/api/persistence/solver-duration-by-season" ".seasons | type" "array"
check_json_field "/api/persistence/solver-duration-by-season has global_stats" GET "/api/persistence/solver-duration-by-season" ".global_stats | type" "object"
check_json_field "/api/persistence/solver-duration-by-season has n_cycles_evaluated" GET "/api/persistence/solver-duration-by-season" ".n_cycles_evaluated | type" "number"
check_endpoint "/api/persistence/solver-duration-by-season with sim_day filter" 200 GET "/api/persistence/solver-duration-by-season?since_sim_day=1&until_sim_day=100"
# iter #71: solver-duration-by-status endpoint
check_endpoint "/api/persistence/solver-duration-by-status (iter #71)" 200 GET "/api/persistence/solver-duration-by-status"
check_json_field "/api/persistence/solver-duration-by-status has statuses array" GET "/api/persistence/solver-duration-by-status" ".statuses | type" "array"
check_json_field "/api/persistence/solver-duration-by-status has global_stats" GET "/api/persistence/solver-duration-by-status" ".global_stats | type" "object"
check_json_field "/api/persistence/solver-duration-by-status has n_cycles_evaluated" GET "/api/persistence/solver-duration-by-status" ".n_cycles_evaluated | type" "number"
