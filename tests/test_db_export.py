...
Covers:
- /api/admin/db-export?table=X&format=Y for 5 tables × 3 formats
...
class TestDBExportEndpoint:
    ...
    def test_export_cycles_json(self):
        resp = self.client.get("/api/admin/db-export?table=cycles&format=json")
    ...
    def test_export_cycles_ndjson(self):
        resp = self.client.get("/api/admin/db-export?table=cycles&format=ndjson")
        assert resp.status_code == 200
    ...
    def test_export_cycles_csv(self):
        resp = self.client.get("/api/admin/db-export?table=cycles&format=csv")
        assert resp.status_code == 200
    ...
    def test_export_supplies_json(self):
        resp = self.client.get("/api/admin/db-export?table=supplies&format=json")
        assert resp.status_code == 200
        data = resp.json()
    ...
    def test_export_matches_json(self):
        resp = self.client.get("/api/admin/db-export?table=matches&format=json")
        assert resp.status_code == 200
        data = resp.json()
        assert len(data) >= 4

    def test_export_matches_ndjson(self):
        resp = self.client.get("/api/admin/db-export?table=matches&format=ndjson")
        assert resp.status_code == 200
    ...
    def test_export_routes_json(self):
        resp = self.client.get("/api/admin/db-export?table=routes&format=json")
        assert resp.status_code == 200
        data = resp.json()
        assert len(data) >= 4
    ...
    def test_export_llm_decisions_json(self):
        resp = self.client.get("/api/admin/db-export?table=llm_decisions&format=json")
        assert resp.status_code == 200
    ...
    def test_invalid_table_returns_400(self):
        resp = self.client.get("/api/admin/db-export?table=bogus&format=json")
        assert resp.status_code == 400
        assert "Unknown table" in resp.json()["detail"]

    def test_invalid_format_returns_400(self):
        resp = self.client.get("/api/admin/db-export?table=cycles&format=xml")
        assert resp.status_code == 400
    ...
    def test_since_sim_day_filter(self):
        ...
        resp = self.client.get(
            "/api/admin/db-export?table=cycles&format=json&since_sim_day=3"
        )
        assert resp.status_code == 200
        data = resp.json()
        assert len(data) == 1
    ...
    def test_since_sim_day_filter_all_match(self):
        ...
        resp = self.client.get(
            "/api/admin/db-export?table=cycles&format=json&since_sim_day=1"
        )
        assert resp.status_code == 200
        data = resp.json()
        assert len(data) == 2
    ...
    def test_since_sim_day_excludes_all(self):
        ...
        resp = self.client.get(
            "/api/admin/db-export?table=cycles&format=json&since_sim_day=10"
        )
        assert resp.status_code == 200
        assert resp.json() == []
    ...
    def test_limit_param(self):
        ...
        resp = self.client.get(
            "/api/admin/db-export?table=cycles&format=json&limit=1"
        )
        assert resp.status_code == 200
        data = resp.json()
        assert len(data) == 1
    ...
    def test_limit_zero_clamped_to_1(self):
        ...
        resp = self.client.get(
            "/api/admin/db-export?table=cycles&format=json&limit=0"
        )
        assert resp.status_code == 200
    ...
    def test_limit_too_large_clamped(self):
        ...
        resp = self.client.get(
            "/api/admin/db-export?table=cycles&format=json&limit=99999"
        )
        assert resp.status_code == 200
