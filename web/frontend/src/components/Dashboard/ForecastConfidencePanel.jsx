      ...
      {chartData.length > 0 && <div className="chart-row" style={{ height: 250, marginTop: '1rem' }}>
        <ResponsiveContainer width="100%" height="100%">
          <ComposedChart data={chartData} margin={{ top: 5, right: 30, left: 60, bottom: 5 }}>
            ...
            <YAxis yAxisId="dispersion" orientation="right" stroke="#f59e0b" unit="%" />
            ...
            <Line yAxisId="left" type="monotone" dataKey="mean" name="Ensemble mean" stroke="#3b82f6" strokeWidth={2} dot={{ r: 3 }} />
            <Line yAxisId="dispersion" type="monotone" dataKey="dispersion_pct" name="Dispersion %" stroke="#f59e0b" strokeDasharray="4 4" dot={false} />
          </ComposedChart>
        </ResponsiveContainer>
      </div>}
    </div>
